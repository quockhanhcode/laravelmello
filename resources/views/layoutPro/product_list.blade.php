					...
					<div class="block box-banner">
						<div id="box-banner" class="carousel slide" data-ride="carousel" data-interval="1500">
							...
							<div class="carousel-inner">
								<div class="item active"><a href="detail.html"><img
								...
								<div class="item"><a href="detail.html"><img
											src="{{asset('fontend/images/banner14.png')}}" alt="banner" /></a>
									<div class="std">
								...
								<div class="item"><a href="detail.html"><img
											src="{{asset('fontend/images/banner15.png')}}" alt="banner" /></a>
									<div class="std">
							...
							@foreach($category_by_id as $key => $list_pro)
								<li class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
									<div class="item-wrap">
										<div class="item-image">
											<a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
												<img class="first_image"
													src="{{URL::to('images/'.$list_pro->product_image)}}"
													alt="Product demo" />
											</a>
											<div class="item-btn">
												<div class="box-inner">
										...
										<div class="pro-info">
											<div class="pro-inner">
												<div class="pro-title product-name"><a href="{{URL::to('/chi-tiet-san-pham/'.$list_pro->product_id)}}">{{$list_pro->product_name}}</a></div>
												<div class="pro-content">
													<div class="wrap-price">
														<div class="price-box">
															<span class="regular-price">
																<span class="price">{{number_format($list_pro->product_price).'VNĐ'}}</span></span>
														</div>
													</div>
													<div class="ratings">
